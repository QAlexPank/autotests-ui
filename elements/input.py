...
class Input(BaseElement):
    ...
    def get_raw_locator(self, nth: int = 0, **kwargs) -> str:
        # Переопределяется метод формирования XPath-селектора:
        #  - сначала общий селектор блока
        #  - затем путь до самого <input>, включая '//input'
    ...
    def fill(self, value: str, nth: int = 0, **kwargs):
        ...
        # После успешного fill фиксируется покрытие как действие FILL
    ...
    def check_have_value(self, value: str, nth: int = 0, **kwargs):
        ...
        # Фиксируется в покрытии, что значение проверено — тип VALUE
